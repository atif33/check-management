...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-home"]], decls: 14, vars: 0, consts: [[1, "login-page", "animate"], [1, "row"], [1, "col-lg-4", "col-lg-offset-4"], ["src", "assets/images/flat-avatar.png", 1, "user-avatar"], ["role", "form"], [1, "form-content"], [1, "form-group"], ["type", "text", "placeholder", "Email", 1, "form-control", "input-underline", "input-lg"], ["type", "password", "placeholder", "Password", 1, "form-control", "input-underline", "input-lg"], [1, "btn", "rounded-btn", 3, "click"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_a_click_12_listener() { return ctx.connect(); });
...
module.exports = __webpack_require__(/*! C:\Users\atif.nabil\gestion-cheques\src\main.ts */"./src/main.ts");
